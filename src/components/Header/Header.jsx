        ...
        <div className={s.outer}>
            <div className={s.container}>
                <div className={s.wrapper}>
                    <div className={s.logo }> H. {/*<img className={s.logo} src={type} alt=""/>*/}</div>
                    <div className={s.nav}>
                        <div className={s.navItem}><a href="#">Home</a></div>
                        <div className={s.navItem}><a href="#">Skills</a></div>
                        <div className={s.navItem}><a href="#">Works</a></div>
                        <div className={s.navItem}><a href="#">Contact</a></div>
                    </div>
